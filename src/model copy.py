...
class ResNetBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.block = nn.Sequential(
            ...
            nn.BatchNorm2d(out_channels),
            nn.ReLU(),
            depthwise_separable_conv(out_channels, out_channels),
        )
...
class MatcherModel(nn.Module):
    def __init__(self):
        ...
        self.positional_encoding = positionalencoding2d(64, height=32, width=32).unsqueeze(0).to(device)
        ...
        model_output_channels = 512 # 256 512
